                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item <?php if($curr_lang == "en") {echo "item_active";} ?>" href="weapons.php?lang=en"><?php echo $lang['lang_en'] ?></a></li>
                            <li><a class="dropdown-item <?php if($curr_lang == "hu") {echo "item_active";} ?>" href="weapons.php?lang=hu"><?php echo $lang['lang_hu'] ?></a></li>
                            <li><a class="dropdown-item <?php if($curr_lang == "cn") {echo "item_active";} ?>" href="weapons.php?lang=cn"><?php echo $lang['lang_cn'] ?></a></li>
                        </ul>
                    </li>
